...
\abstract{Of all the tools and methods invented by humankind to tame nature and make use of its challenges, the invention of computer has had the greatest impact on society.
 ...
 This paper explores the ethical problems that the creation of AI will raise, and it attribute these problems resulted from widely varying definitons and the applications of these .
}
