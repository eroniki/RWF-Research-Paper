...
In light of these definitions, robots have to interact with its environment. However, such definitions exclude any means of social interactions, even though \citeA{lan} asserts that socially interactive robots are significantly popular in society.
...
On the one hand,  \citeA[p.~943]{lin} note that robots are employed in such tasks called "three D's" referring "dull, dirty, or dangerous" tasks.
...
On the other hand, \citeA{lan} and \citeA{lin} list many different real life robotic applications, from laborer robots to medical purpose robots and to personal care and companion robots, which contradicts with given instruction.
